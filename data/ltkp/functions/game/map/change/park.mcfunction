...
tellraw @s [{"text": "マップを"},{"nbt":"Map.Park.Name","storage":"ltkp:","interpret": true},{"text": "に設定しています。"}]
...
tellraw @s [{"text": "マップを"},{"nbt":"Map.Park.Name","storage":"ltkp:","interpret": true},{"text": "に設定しました。"}]
